        ...
        {showReading && (
          <section className="w-full px-2 md:px-4 py-16">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-4 grid-rows-5 gap-x-3 gap-y-0 md:gap-x-12 md:gap-y-14 max-w-xs md:max-w-xl mx-auto relative md:h-200" style={{height: "514px", minHeight: "514px"}}>
